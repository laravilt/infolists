...
{
    protected string $description = 'Search the Laravilt Infolists documentation';

    public function handle(Request $request): Response
    {
        $query = $request->string('query');
        $packagePath = base_path('packages/laravilt/infolists');
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'query' => $schema->string()
                ->description('QUERY_Search the Laravilt Infolists documentation')
                ->required(),
        ];
    }
