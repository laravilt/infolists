...
class InstallInfolistsCommand extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'infolists:install
     ...
     */
    protected $description = 'Install Infolists plugin';
...
protected function publishAssets(): void
    ...
    }protected function buildAssets(): void
    {
        ...
        $process = Process::path(base_path('packages/laravilt/infolists'))
